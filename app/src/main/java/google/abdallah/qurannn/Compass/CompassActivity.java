package google.abdallah.qurannn.Compass;
            ...
            if(gps.getLocation() != null) {
                ...
                try {
                    ...
                    if (addresses.size() > 0) {
                        ...
                        stringBuffer.append("Adresss line" + address.getAddressLine(0) + "\n");
                        stringBuffer.append("Admin Area" + address.getAdminArea() + "\n");
                        stringBuffer.append("Contry name" + address.getCountryName() + "\n");
                        stringBuffer.append("locality" + address.getLocality() + "\n");
                        stringBuffer.append("Locale" + address.getLocale() + "\n");
                        stringBuffer.append("Sub locality" + address.getSubLocality() + "\n");
                        stringBuffer.append("Sub Min Area" + address.getSubAdminArea() + "\n");
